...
int32_t main(int32_t argc, char *argv[])
{
    ...
    ICPU_RUN_KF(reduce_min_custom, blockDim, inputGM, outputGM); // use this macro for cpu debug
    ...
    ACLRT_LAUNCH_KERNEL(reduce_min_custom)(blockDim, stream, xDevice, zDevice);
